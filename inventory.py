...
# Print default vehicle properties
for key, value in myVehicle.items():
    print("{} : {}".format(key,value))

myInventoryList = []

# Read CSV and build inventory list
...
# Print loaded cars from inventory (Un-indented from the 'with' block)
    for myCarProperties in myInventoryList:
        for key, value in myCarProperties.items():
            print("{} : {}".format(key,value))
        print("-----")  # Out of inner loop, prints once per car
